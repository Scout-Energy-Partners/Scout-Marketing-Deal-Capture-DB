<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Deal_Capture_Web_Development.Login" %>


    <asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div class="container-fluid" style=" background: url('file:///C:/Users/adam.gaddis/Documents/Github/Scout-Marketing-Deal-Capture-DB/DealCapture_Web_DEV/DealCapture_Web_DEV/Content/Images/background.jpg');">
